...
class VacantesServiceImpl  implements IVacantesService {
  ...
  VacantesServiceImpl(){
    ...
    try {
      ...
      vacante1.setDescripcion("Se solicita empleado")
      ...
      vacante2.setDescripcion("Se solicita empleado")
      ...
      vacante3.setDescripcion("Se solicita empleado")
      ...
      vacante4.setDescripcion("Se solicita empleado")
